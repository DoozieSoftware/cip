...
5. If collection was impossible, save as **Missed** with the reason (nobody home, address issue, refused). The citizen sees the explanation and the request can go on a later trip.
...
- Completed trips move to **History** with actuals, timestamps, and proof photos for reconciliation.
- Missed requests return to the scheduling pool.
