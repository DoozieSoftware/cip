...
| P2-14 | **Done** | Privacy-safe, allowlisted product telemetry endpoint and browser fire-and-forget client cover report funnel, GPS/media failures, notifications, reopen, and accessibility preference signals (`ProductAnalyticsService`, `frontend/src/shared/analytics.ts`). |
