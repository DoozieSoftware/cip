...
**Version:** 1.0
**Status:** In Progress (17 / 30 tasks complete)
**Last updated:** 2026-06-26 18:50 IST (after T-M2-018 done)
...
* Active task: **T-M2-019 — BasePolicy + RoleService** (next: `app/Modules/Shared/BasePolicy.php` with `before()` checking role/permission; `RoleService::assign`, `revoke`, `hasPermission`; integrates with Spatie).
* Blockers: none.
