...
**Version:** 1.0
**Status:** In Progress (18 / 30 tasks complete)
**Last updated:** 2026-06-26 19:10 IST (after T-M2-019 done)
...
* Active task: **T-M2-020 — AuditMiddleware + AuditLog model + audit_logs migration** (next: capture entity, action, before/after, IP, device fingerprint, request id, user id; write to `audit_logs` for every mutating request).
* Blockers: none.
