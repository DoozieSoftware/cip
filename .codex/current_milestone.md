...
**Version:** 1.0
**Status:** In Progress (20 / 30 tasks complete)
**Last updated:** 2026-06-26 19:50 IST (after T-M2-021 done)
...
* Active task: **T-M2-022 — Configure rate limiters per docs/11 §21** (next: register named limiters `otp`, `citizen`, `uploads`, `moderator`, `department`, `admin` in `App\Providers\RouteServiceProvider`).
* Blockers: none.
