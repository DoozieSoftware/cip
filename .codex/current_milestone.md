...
**Version:** 1.0
**Status:** In Progress (28 / 30 tasks complete)
**Last updated:** 2026-06-26 22:50 IST (after T-M2-029 done)
...
* Active task: **T-M2-030 — Wire M2 documentation into README** (next: add an `Authentication` section to `README.md` that links to `docs/auth.md`, OpenAPI, and explains seeded roles).
* Blockers: none.
