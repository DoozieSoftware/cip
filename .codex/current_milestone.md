...
**Version:** 1.0
**Status:** In Progress (3 / 24 tasks complete)
**Last updated:** 2026-06-27 00:10 IST (after T-M3-003 done)
...
* Active task: **T-M3-004 — Create cities migration and model** (next: cities table with district_id FK, name, code, active).
* Blockers: none.
