    ...
    <div className="space-y-4">
      ...
      {list.isLoading ? (
        ...
        <EmptyState
          ...
          action={<Link to="/citizen/submit" className="mt-2 rounded-full bg-emerald-600 px-3.5 py-2 text-sm font-semibold text-white">Report an issue</Link>}
        />
      ) : (
          ...
          {(list.data ?? []).map((n) => (
            <li
              ...
              className={cx(
                ...
                n.read_at ? 'border-slate-200' : 'border-emerald-300 ring-1 ring-emerald-200',
              )}
            >
