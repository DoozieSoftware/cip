...
function Icon({ name }: { name: IconName }): JSX.Element {
  const paths: Record<IconName, JSX.Element> = {
    ...
    building: (
      <>
        <path d="M4 21V3h11v18M15 9h5v12M8 7h3M8 11h3M8 15h3" />
      </>
    ),
    users: (
      <>
    ...
    tag: (
      <>
        <path d="m20.6 13.6-7 7a2 2 0 0 1-2.8 0L3 12.8V4h8.8l8.8 8.8a1 1 0 0 1 0 .8Z" />
    ...
    route: (
      <>
        ...
        <path d="M6 16V8a3 3 0 0 1 3-3h6M18 8v8a3 3 0 0 1-3 3H9" />
      </>
    ),
    workflow: (
      <>
    ...
    cpu: (
      <>
        ...
        <path d="M9 1v3M15 1v3M9 20v3M15 20v3M20 9h3M20 14h3M1 9h3M1 14h3M9 9h6v6H9z" />
      </>
    ),
    ...
    archive: (
      <>
        <path d="M3 6h18M5 6v15h14V6M9 10h6" />
        <rect x="2" y="3" width="20" height="3" rx="1" />
      </>
    ),
    audit: (
      <>
        <path d="M4 3h16v18H4zM8 7h8M8 11h8M8 15h5" />
      </>
    ),
