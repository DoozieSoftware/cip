...
const PROMPTS = [
  {
    ...
    purpose: 'Classify an uploaded image',
    prompt_text: 'You are an image classifier. {{slot}}',
  },
  {
    id: 'pv2',
    name: 'classify_image',
    ...
    purpose: 'Classify an uploaded image v2',
    prompt_text: 'You are an image classifier v2. {{slot}}',
  },
];
...
describe('AdminAi (T-M12-021)', () => {
  ...
  beforeEach(() => {
    ...
    (useAiProviders as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      data: PROVIDERS,
      isLoading: false,
    });
    (useAiPrompts as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      data: PROMPTS,
      isLoading: false,
    });
