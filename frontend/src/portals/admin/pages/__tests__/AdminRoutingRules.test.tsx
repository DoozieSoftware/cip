...
const ROWS = [
  {
    id: 'r1',
    name: 'Garbage to BBMP',
    description: 'Ward 112',
    conditions: { any_label: ['garbage'] },
    destination_department_id: 'd-bbmp-w112',
    destination_department: { id: 'd-bbmp-w112', code: 'BBMP-112', name: 'BBMP Ward 112' },
    priority: 10,
    active: true,
    created_at: null,
    updated_at: null,
  },
  {
    ...
    description: 'BTP',
    conditions: { any_label: ['parking'] },
    destination_department_id: 'd-btp',
    priority: 20,
    active: true,
    created_at: null,
    updated_at: null,
...
describe('AdminRoutingRules (T-M12-020)', () => {
  ...
  beforeEach(() => {
    ...
    (useRoutingRules as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      data: ROWS,
      isLoading: false,
    });
