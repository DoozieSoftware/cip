...
const JOBS = [
  {
    ...
    command: 'Send queued notifications',
    expression: 'everyMinute',
    next_due_at: '2026-06-29T10:01:00Z',
    paused: false,
  },
  {
    id: 'cleanup-audit',
    command: 'Cleanup old audit rows',
    expression: 'daily',
    next_due_at: '2026-06-30T00:00:00Z',
    paused: true,
  },
];
...
describe('AdminScheduler (T-M12-026)', () => {
  ...
  it('shows the running / paused counts', () => {
    render(
      <QueryClientProvider client={client}>
        <MemoryRouter>
          <AdminScheduler />
